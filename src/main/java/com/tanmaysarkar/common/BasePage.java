...
public abstract class BasePage {
	...
	public String getElementText(By element) {
		waitUntilElementIsDisplayedOnScreen(element);
		try {
			return StringUtils.trim(_driver.findElement(element).getText());
		} catch (Exception e) {
	...
	public void scrollToThenClick(WebElement selector) {
	...
	public void waitForElementToDisplay(WebElement Selector) {
	...
	public void selectIfOptionTextContains(WebElement selector, String searchCriteria) {
	...
	public void selectIfOptionTextEquals(WebElement selector, String searchCriteria) {
	...
	public List<String> getDropdownValues(WebElement selector) {
	...
	public static boolean searchText(WebDriver web, String text) {
		...
		try {
			...
			System.out.println("Cannot find text: " + e);
			return false;
		}
		return false;
	}
